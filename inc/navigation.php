...
function ea_site_header() {
    ...
    echo '<div class="nav-header"><a class="nav-header__logo" title="' . get_bloginfo('name') . '" href="' . get_bloginfo('url') . '" style="background-image: url(' . get_stylesheet_directory_uri('url') . '/assets/images/logo.png);background-size:cover;">' . get_bloginfo('name') . '</a></div>';
